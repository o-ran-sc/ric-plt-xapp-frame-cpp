...
namespace xapp
{
	...
	*/
	...
	oresponse_t cpprestclient::post_subscrtiptions(const nlohmann::json & json, std::string path) {
		oresponse_t res;
		res.status_code = 0;
		res.SubscriptionId = "";
	...
	int  cpprestclient::delete_subscrtiptions(std::string Id, std::string path)
	{
		int status_code=0;
