...
class WrapHandler {
	private:
		...
		WrapHandler() = default;
	public:
		static WrapHandler& getInstance() {
			static WrapHandler* p_WrapHandler = new WrapHandler();
			return *p_WrapHandler;
		}

		void set(Xapp* _p_Xapp) {
			p_Xapp = _p_Xapp;
		}
...
class Xapp : public xapp::Messenger {
	...
	public:
		...
		static void signalHandler(int signum) {
			static WrapHandler& p_WrapHandler = WrapHandler::getInstance();
			p_WrapHandler.get()->deregisterXapp();
			exit(signum);
			return;
		}
};
